...
class population {
    constructor(totalMembers) {
        ...
        this.bestPhenotypeToDate = this.members[1];
    ...
    selectNextGeneration() {
        ...
        */
        ...
        parentArrayA = parentBucketA.slice(0, this.totalMembers);
        parentArrayB = parentBucketB.slice(0, this.totalMembers);
        ...
        console.log('parentArrayA.length: ' + parentBucketA.length);
